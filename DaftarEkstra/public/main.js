...
function deleteEkstra() {
    var deleteURL = `/ekstra/delete/${ekstraID}`;

    $.ajax({
        url: deleteURL,
    }).done(function () {
        window.location.href = "/ekstra";
    })
}

function deleteNilai() {
    var deleteURL = `/nilai/delete/${nilaiID}`;
...
function deleteAnggota() {
    var deleteURL = `/anggota/delete/${anggotaID}`;
